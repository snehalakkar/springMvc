...
public class AddController {
	...
	public ModelAndView editCountry1(@RequestParam("file") CommonsMultipartFile file, @ModelAttribute("country") @Valid Country country, BindingResult res, HttpServletRequest request,
